      ...
      <div className="w-full max-w-screen-xl mx-auto px-4">
        <div className="md:flex md:items-center md:h-[80px]">
          <div className="relative h-[68px] md:h-auto flex items-center justify-between md:justify-start md:pr-[30px]">
            <Link href="/" className="business-image">
              <Image src="/images/topcv-logo-cropped.png" width={100} height={25} alt="topcv logo" className="md:mb-[-10px]" />
            </Link>
          ...
          <nav id="mb-menu" className="hidden w-full md:flex">
            ...
            <div className="md:flex md:items-center md:justify-end md:py-0 md:ml-auto md:gap-[8px]">
              ...
              <div className="md:flex hidden items-center justify-center gap-[12px]">
                <Link href="/login" className="bg-white border border-green-600 w-fit py-[9px] px-[16px] rounded block text-green-600 text-center whitespace-nowrap hover:bg-green-50 transition-colors">Đăng nhập</Link>
                <Link href="/register" className="bg-green-600 border border-green-600 py-[9px] px-[16px] rounded block text-white text-center whitespace-nowrap hover:bg-green-700 transition-colors">Đăng ký</Link>
              </div>
              <div className="md:hidden flex flex-col items-center justify-center gap-[12px] w-full px-[16px] py-4">
                <Link href="/register" className="bg-green-600 border border-green-600 py-[9px] px-[16px] rounded block text-white text-center whitespace-nowrap w-full hover:bg-green-700 transition-colors">Đăng ký</Link>
                <Link href="/login" className="bg-white border border-green-600 py-[9px] px-[16px] rounded block text-green-600 text-center whitespace-nowrap w-full hover:bg-green-50 transition-colors">Đăng nhập</Link>
              </div>
            </div>
          </nav>
        </div>
